cmd_drivers/pinctrl/ngxxfus/pinctrl-nf271x.o := aarch64-linux-gnu-gcc -Wp,-MD,drivers/pinctrl/ngxxfus/.pinctrl-nf271x.o.d -nostdinc -isystem /usr/lib/gcc-cross/aarch64-linux-gnu/13/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -Wno-pointer-sign -Wno-stringop-truncation -Wno-zero-length-bounds -Wno-array-bounds -Wno-stringop-overflow -Wno-maybe-uninitialized -fmacro-prefix-map=./= -gdwarf-4 -fstack-usage -Wno-format-nonliteral -Wno-address-of-packed-member -Wno-unused-but-set-variable -Werror=date-time -Wno-packed-not-aligned -D__ARM__ -fno-pic -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-x18 -mgeneral-regs-only -mbranch-protection=none -pipe -march=armv8-a+crc -D__LINUX_ARM_ARCH__=8 -I./arch/arm/mach-nf271x/include    -DKBUILD_BASENAME='"pinctrl_nf271x"'  -DKBUILD_MODNAME='"pinctrl_nf271x"' -c -o drivers/pinctrl/ngxxfus/pinctrl-nf271x.o drivers/pinctrl/ngxxfus/pinctrl-nf271x.c

source_drivers/pinctrl/ngxxfus/pinctrl-nf271x.o := drivers/pinctrl/ngxxfus/pinctrl-nf271x.c

deps_drivers/pinctrl/ngxxfus/pinctrl-nf271x.o := \
...
drivers/pinctrl/ngxxfus/pinctrl-nf271x.o: $(deps_drivers/pinctrl/ngxxfus/pinctrl-nf271x.o)
