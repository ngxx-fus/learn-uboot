...
static int nf271x_pl011_serial_probe(struct udevice *dev)
{
...
static int nf271x_pl011_serial_setbrg(struct udevice *dev, int baudrate)
{
	int r;
...
static const struct dm_serial_ops nf271x_pl011_serial_ops = {
	.putc = pl01x_serial_putc,
	.pending = pl01x_serial_pending,
	.getc = pl01x_serial_getc,
	.setbrg = nf271x_pl011_serial_setbrg,
};

static const struct udevice_id nf271x_pl011_serial_id[] = {
	{.compatible = "ngxxfus,nf2711-pl011", .data = TYPE_PL011},
	{}
};

U_BOOT_DRIVER(nf271x_pl011_uart) = {
	.name	= "nf271x_pl011",
	.id	= UCLASS_SERIAL,
	.of_match = of_match_ptr(nf271x_pl011_serial_id),
	.probe	= nf271x_pl011_serial_probe,
	.plat_auto	= sizeof(struct pl01x_serial_plat),
	.ops	= &nf271x_pl011_serial_ops,
