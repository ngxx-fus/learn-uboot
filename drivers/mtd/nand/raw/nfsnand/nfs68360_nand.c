...
static bool bcm68360_nand_intc_ack(struct nfsnand_soc *soc)
{
...
static void bcm68360_nand_intc_set(struct nfsnand_soc *soc, bool en)
{
	struct bcm68360_nand_soc *priv =
			container_of(soc, struct bcm68360_nand_soc, soc);
...
static int bcm68360_nand_probe(struct udevice *dev)
{
	...
	nfsnand_writel(0, priv->base + BCM68360_NAND_INT_EN);
	nfsnand_writel(0, priv->base + BCM68360_NAND_INT);
