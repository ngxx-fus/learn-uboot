...
static bool bcm63158_nand_intc_ack(struct nfsnand_soc *soc)
{
...
static void bcm63158_nand_intc_set(struct nfsnand_soc *soc, bool en)
{
	struct bcm63158_nand_soc *priv =
			container_of(soc, struct bcm63158_nand_soc, soc);
...
static int bcm63158_nand_probe(struct udevice *dev)
{
	...
	nfsnand_writel(0, priv->base + BCM63158_NAND_INT_EN);
	nfsnand_writel(0, priv->base + BCM63158_NAND_INT);
